...
class SmashPatty : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_smash_patty)

        val buttonBackToMainFromBeef = findViewById<ImageButton>(R.id.btnBackarrowSmash)
