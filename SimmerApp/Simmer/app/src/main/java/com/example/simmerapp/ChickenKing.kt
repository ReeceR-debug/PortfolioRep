...
class ChickenKing : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chicken_ala_king)

        val buttonBackToMainFromBeef = findViewById<ImageButton>(R.id.btnBackarrowKing)
